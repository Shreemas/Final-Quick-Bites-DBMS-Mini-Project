...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a style="background-color:rgb(100,13,13);color:white;" href="delete_food_items.php" class="list-group-item active">Delete Food Items</a>
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <?php } ?>
    ...
    <br>
          ...
          <button style="background-color:rgb(100,13,13);" type="submit" id="submit" name="delete" value="Delete" class="btn btn-danger pull-right"> DELETE</button>    
      </div>
