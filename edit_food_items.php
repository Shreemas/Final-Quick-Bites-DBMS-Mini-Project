...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		...
    		<a style="background-color:rgb(100,13,13);color:white;" href="edit_food_items.php" class="list-group-item active">Edit Food Items</a>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
          <button  style="background-color:rgb(100,13,13);" type="submit" id="submit" name="submit" class="btn btn-primary pull-right" onclick="display_alert()" value="Display alert box" > Update </button>    
      </div>
        </form>
